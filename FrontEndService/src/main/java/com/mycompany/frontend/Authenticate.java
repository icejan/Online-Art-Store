...
public class Authenticate {
   SignatureAlgorithm signatureAlgorithm;
    ...
    public Authenticate() {
        ...
        secretString = Encoders.BASE64.encode("mysecuresecurecodeabcdefghijklmnopqrstuvwxyz123456789023445678912344567123abcdefghijklmnopqrstuvwyz1234567890".getBytes());
    ...
    public Entry<Boolean, String> verify(String jwt) throws UnsupportedEncodingException {
        ...
        try {
            jws = Jwts.parserBuilder() // (1)
                    .setSigningKey("mysecuresecurecodeabcdefghijklmnopqrstuvwxyz123456789023445678912344567123abcdefghijklmnopqrstuvwyz1234567890".getBytes()) // (2)
                    .build() // (3)
